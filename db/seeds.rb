...
handles = %w(内臓処理 内臓処理+ゼイゴの処理 内臓処理+皮を剥ぐ 内臓処理+ウロコの処理 3枚おろし 3枚おろし+ゼイゴの処理 3枚おろし+ゼイゴの処理+骨の処理 3枚おろし+ゼイゴの処理+骨の処理+皮を剥ぐ 3枚おろし+ウロコの処理 背開き+骨の処理 背開き+ゼイゴの処理)
...
aji_cookings = [
    ...
    {cooking_name: "塩焼き", cooking_image: "塩焼き.jpg", cooking_url: "https://www.kurashiru.com/recipes/c70654e6-d9ba-4f51-a66a-c90c58490925", handle_pattern: "内臓処理+ゼイゴの処理", cooking_total_time: 30, rest_fish_time: 10, cooking_time: 15},
    ...
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/83e46755-0f2e-44ea-a322-497bbfcccd39", handle_pattern: "内臓処理+ゼイゴの処理", cooking_total_time: 20, rest_fish_time: 0, cooking_time: 10},
    ...
    {cooking_name: "炊き込みご飯", cooking_image: "sample.jpg", cooking_url: "https://delishkitchen.tv/recipes/149663037043769763", handle_pattern: "内臓処理+ゼイゴの処理", cooking_total_time: 60, rest_fish_time: 0, cooking_time: 50},
...
mameaji_cookings = [
    {cooking_name: "唐揚げ", cooking_image: "唐揚げ.jpg", cooking_url: "https://www.kurashiru.com/recipes/0b5e9148-f191-42d8-932a-ed40b71549b0", handle_pattern: "内臓処理+ゼイゴの処理", cooking_total_time: 15, rest_fish_time: 0, cooking_time: 5},
    {cooking_name: "磯辺揚げ", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/960d103c-012a-4185-9497-c6b412d12ba4", handle_pattern: "内臓処理+ゼイゴの処理", cooking_total_time: 25, rest_fish_time: 15, cooking_time: 5}
]
...
kasago_cookings = [
    {cooking_name: "唐揚げ", cooking_image: "唐揚げ.jpg", cooking_url: "https://www.kurashiru.com/recipes/308a73f5-41d6-4ca6-9aa7-dcb73dc75261", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 30, rest_fish_time: 10, cooking_time: 5},
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/5676092a-3ef2-4700-a90a-e8631344a1d8", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 30, rest_fish_time: 0, cooking_time: 7},
    {cooking_name: "汁", cooking_image: "sample.jpg", cooking_url: "https://www.jinta-express.com/entry/kasagomisosiru", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 20, rest_fish_time: 0, cooking_time: 15}
]

tachiuo_cookings = [
    {cooking_name: "唐揚げ", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/80e6ef31-4b18-4b7b-a424-57826b118cad", handle_pattern: "3枚おろし", cooking_total_time: 40, rest_fish_time: 15, cooking_time: 3},
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/023f9c5f-97a9-41be-9e24-298f13260f64", handle_pattern: "内臓処理", cooking_total_time: 40, rest_fish_time: 0, cooking_time: 20},
    {cooking_name: "塩焼き", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/3698861e-557d-4f9b-9d25-9d1aafc930f4", handle_pattern: "内臓処理", cooking_total_time: 30, rest_fish_time: 15, cooking_time: 10},
    {cooking_name: "ムニエル", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/89393bee-66dc-4db0-bbe2-c7938f325f04", handle_pattern: "内臓処理", cooking_total_time: 20, rest_fish_time: 5, cooking_time: 10}
]

kawahagi_cookings = [
    {cooking_name: "唐揚げ", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/d2f9ccf2-1d18-41b1-8273-3ba5b9c05d36", handle_pattern: "内臓処理+皮を剥ぐ", cooking_total_time: 40, rest_fish_time: 0, cooking_time: 5},
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/e86a592a-c639-4653-9933-b979cf522649", handle_pattern: "内臓処理+皮を剥ぐ", cooking_total_time: 30, rest_fish_time: 0, cooking_time: 11}
]

ishimochi_cookings = [
    {cooking_name: "塩焼き", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/7eb416fa-ca8c-4fd1-ae7d-4a7b02d093df", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 30, rest_fish_time: 10, cooking_time: 15},
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://www.kurashiru.com/recipes/e5c44c5b-c3a3-40ac-931f-e2a2cfc22a03", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 30, rest_fish_time: 0, cooking_time: 11},
    {cooking_name: "ソテー", cooking_image: "sample.jpg", cooking_url: "https://recipe.rakuten.co.jp/recipe/1440000846/", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 15, rest_fish_time: 0, cooking_time: 10}
]

mejina_cookings = [
    {cooking_name: "塩焼き", cooking_image: "sample.jpg", cooking_url: "https://recipe.rakuten.co.jp/recipe/1570026079/", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 10, rest_fish_time: 0, cooking_time: 10},
    {cooking_name: "煮付け", cooking_image: "sample.jpg", cooking_url: "https://cookpad.com/recipe/4138440", handle_pattern: "内臓処理+ウロコの処理", cooking_total_time: 25, rest_fish_time: 0, cooking_time: 25},
    {cooking_name: "ムニエル", cooking_image: "sample.jpg", cooking_url: "https://cookpad.com/recipe/293169", handle_pattern: "3枚おろし+ウロコの処理", cooking_total_time: 15, rest_fish_time: 10, cooking_time: 5},
    {cooking_name: "フライ", cooking_image: "sample.jpg", cooking_url: "https://recipe.rakuten.co.jp/recipe/1770028723/", handle_pattern: "3枚おろし+ウロコの処理", cooking_total_time: 5, rest_fish_time: 0, cooking_time: 1}
]
...
aji_handles = [
    ...
    {handle_pattern: "3枚おろし+ゼイゴの処理+骨の処理+皮を剥ぐ", handle_time: 13, handle_url: "https://www.youtube.com/embed/YukRUVPenjc"},
...
kasago_cookings.each do |kasago_cooking|
    ...
    kasago.cooking_informations.create(cooking_id: cooking_id, image: image, cooking_url: cooking_url, handle_id: handle_id, cooking_total_time: cooking_total_time, rest_fish_time: rest_fish_time, cooking_time: cooking_time)
end
...
tachiuo_cookings.each do |tachiuo_cooking|
    ...
    tachiuo.cooking_informations.create(cooking_id: cooking_id, image: image, cooking_url: cooking_url, handle_id: handle_id, cooking_total_time: cooking_total_time, rest_fish_time: rest_fish_time, cooking_time: cooking_time)
end
...
kawahagi_cookings.each do |kawahagi_cooking|
    ...
    kawahagi.cooking_informations.create(cooking_id: cooking_id, image: image, cooking_url: cooking_url, handle_id: handle_id, cooking_total_time: cooking_total_time, rest_fish_time: rest_fish_time, cooking_time: cooking_time)
end
...
ishimochi_cookings.each do |ishimochi_cooking|
    ...
    ishimochi.cooking_informations.create(cooking_id: cooking_id, image: image, cooking_url: cooking_url, handle_id: handle_id, cooking_total_time: cooking_total_time, rest_fish_time: rest_fish_time, cooking_time: cooking_time)
end
...
mejina_cookings.each do |mejina_cooking|
    ...
    mejina.cooking_informations.create(cooking_id: cooking_id, image: image, cooking_url: cooking_url, handle_id: handle_id, cooking_total_time: cooking_total_time, rest_fish_time: rest_fish_time, cooking_time: cooking_time)
end
