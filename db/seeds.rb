...
aji_cookings = [
  { cooking_name: 'フライ', cooking_image: 'フライ.jpg',
    ...
    handle_pattern: '背開き+ゼイゴの処理', cooking_total_time: 30, rest_fish_time: 5, cooking_time: 3 },
  ...
  { cooking_name: '天ぷら', cooking_image: '天ぷら.jpg',
    ...
    handle_pattern: '背開き+ゼイゴの処理', cooking_total_time: 20, rest_fish_time: 10, cooking_time: 2 },
  { cooking_name: 'なめろう', cooking_image: 'なめろう.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/f0529d5f-630d-4db5-a76e-9cc996bdd653',
    handle_pattern: '3枚おろし+ゼイゴの処理+骨の処理+皮を剥ぐ', cooking_total_time: 15, rest_fish_time: 0, cooking_time: 2 },
  ...
  { cooking_name: '煮付け', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理+ゼイゴの処理', cooking_total_time: 20, rest_fish_time: 0, cooking_time: 10 },
  ...
  { cooking_name: '炊き込みご飯', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理+ゼイゴの処理', cooking_total_time: 60, rest_fish_time: 0, cooking_time: 50 },
...
mameaji_cookings = [
  { cooking_name: '唐揚げ', cooking_image: '唐揚げ.jpg',
    ...
    handle_pattern: '内臓処理+ゼイゴの処理', cooking_total_time: 15, rest_fish_time: 0, cooking_time: 5 },
  { cooking_name: '磯辺揚げ', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理+ゼイゴの処理', cooking_total_time: 25, rest_fish_time: 15, cooking_time: 5 }
]

ika_cookings = [
  { cooking_name: 'フライ', cooking_image: 'フライ.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/6c4907e3-7062-4549-a627-3a10cc383e92',
    handle_pattern: '内臓処理+皮を剥ぐ', cooking_total_time: 20, rest_fish_time: 0, cooking_time: 2 },
  { cooking_name: '刺身', cooking_image: '刺身.jpg',
  ...
  { cooking_name: '天ぷら', cooking_image: '天ぷら.jpg',
    ...
    handle_pattern: '内臓処理+皮を剥ぐ', cooking_total_time: 30, rest_fish_time: 0, cooking_time: 2 },
  { cooking_name: '煮付け', cooking_image: '煮付け.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/a2baa244-bc89-472f-9639-bdf0705f1077',
    handle_pattern: '内臓処理', cooking_total_time: 20, rest_fish_time: 0, cooking_time: 15 },
  { cooking_name: 'ソテー', cooking_image: 'sample.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/372cea8a-0952-4e02-96de-894af709aa45',
    handle_pattern: '内臓処理', cooking_total_time: 20, rest_fish_time: 0, cooking_time: 3 },
  { cooking_name: '姿焼き', cooking_image: '姿焼き.jpg',
    cooking_url: 'https://delishkitchen.tv/recipes/157627457397064083',
    handle_pattern: '内臓処理', cooking_total_time: 20, rest_fish_time: 10, cooking_time: 8 },
...
kasago_cookings = [
  ...
  { cooking_name: '煮付け', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 30, rest_fish_time: 0, cooking_time: 7 },
  { cooking_name: '汁', cooking_image: 'sample.jpg',
    cooking_url: 'https://www.jinta-express.com/entry/kasagomisosiru',
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 20, rest_fish_time: 0, cooking_time: 15 }
]
...
tachiuo_cookings = [
  { cooking_name: '唐揚げ', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '3枚おろし', cooking_total_time: 40, rest_fish_time: 15, cooking_time: 3 },
  { cooking_name: '煮付け', cooking_image: 'sample.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/023f9c5f-97a9-41be-9e24-298f13260f64',
    handle_pattern: '内臓処理', cooking_total_time: 40, rest_fish_time: 0, cooking_time: 20 },
  { cooking_name: '塩焼き', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理', cooking_total_time: 30, rest_fish_time: 15, cooking_time: 10 },
  { cooking_name: 'ムニエル', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理', cooking_total_time: 20, rest_fish_time: 5, cooking_time: 10 }
]

kawahagi_cookings = [
  { cooking_name: '唐揚げ', cooking_image: 'sample.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/d2f9ccf2-1d18-41b1-8273-3ba5b9c05d36',
    handle_pattern: '内臓処理+皮を剥ぐ', cooking_total_time: 40, rest_fish_time: 0, cooking_time: 5 },
  { cooking_name: '煮付け', cooking_image: 'sample.jpg',
    cooking_url: 'https://www.kurashiru.com/recipes/e86a592a-c639-4653-9933-b979cf522649',
    handle_pattern: '内臓処理+皮を剥ぐ', cooking_total_time: 30, rest_fish_time: 0, cooking_time: 11 }
]
...
ishimochi_cookings = [
  ...
  { cooking_name: '煮付け', cooking_image: 'sample.jpg',
    ...
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 30, rest_fish_time: 0, cooking_time: 11 },
  { cooking_name: 'ソテー', cooking_image: 'sample.jpg', cooking_url: 'https://recipe.rakuten.co.jp/recipe/1440000846/',
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 15, rest_fish_time: 0, cooking_time: 10 }
]

mejina_cookings = [
  { cooking_name: '塩焼き', cooking_image: 'sample.jpg', cooking_url: 'https://recipe.rakuten.co.jp/recipe/1570026079/',
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 10, rest_fish_time: 0, cooking_time: 10 },
  { cooking_name: '煮付け', cooking_image: 'sample.jpg', cooking_url: 'https://cookpad.com/recipe/4138440',
    handle_pattern: '内臓処理+ウロコの処理', cooking_total_time: 25, rest_fish_time: 0, cooking_time: 25 },
